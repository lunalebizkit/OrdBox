...
export interface DebitMemoDetailList {
    stock: number,
    productId:number;
    ownCode : number;
    code : number;
...
export function debitMemoGridParser(value: any, iva: number) {
    ...
    export function debitMemoDetailParser(value: any, iva: number) {
        ...
        export function debitMemoGridFromInvoiceParser(value: any) {
         return {
           stock: value.quantity,
         ...
         export function debitMemoDetailFromInvoiceParser(value: any) {
             return {
               id: 0,
               debitId: 0,
               productId: value.productId,
