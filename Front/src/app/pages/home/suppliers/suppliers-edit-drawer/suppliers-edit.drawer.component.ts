...
@Component({
    selector: 'app-suppliers-edit-drawer',
    templateUrl: './suppliers-edit.drawer.component.html',
})

export class SuppliersEditDrawerComponent extends BaseComponent implements OnInit {
