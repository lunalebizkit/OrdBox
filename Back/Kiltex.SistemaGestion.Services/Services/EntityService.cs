...
namespace Kiltex.SistemaGestion.Services.Services
{
    public class EntityService : BaseService
    {
        ...
        public async Task<OperationResponse<DtoSupplier>> GetSupplierById(long id)
        {
            ...
            if (proveedor == null)
            {
                return new OperationResponse<DtoSupplier>(null, false, new OperationExceptions("000", $"Proveedor no encontrado {id}"));
            }
        ...
        public async Task<OperationResponse<DtoEntity>> GetById(long id)
        {
            ...
            if (entidad == null)
                ...
                return new OperationResponse<DtoEntity>(null, false, new OperationExceptions("000", $"Cliente no encontrado {id}"));
